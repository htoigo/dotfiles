...
This function should only modify configuration layer settings."
  (setq-default
   ...
   dotspacemacs-additional-packages '(all-the-icons nvm)
...
before packages are loaded."
  ...
  ;; Functions and keybindings to make moving the current line up or down more
  ;; convenient. This code was found at:
  ;; https://emacsredux.com/blog/2013/04/02/move-current-line-up-or-down/

  (defun move-line-up ()
    "Move the current line up through previous lines."
    (interactive)
    (transpose-lines 1)
    (forward-line -2)
  ...
  (defun move-line-down ()
    "Move the current line down through following lines."
    (interactive)
    (forward-line 1)
    (transpose-lines 1)
    (forward-line -1)
